...
cd procdump
start-process powershell -argument "$PWD\procdump.exe -w -s 7 -n 100 -ma vstest.console -accepteula"
start-process powershell -argument "$PWD\procdump.exe -w -s 7 -n 100 -ma vstest.executionengine -accepteula"
